...
int main()
{
  ...
  //cout << endl << "From dateType section (Part II):" << endl;
  //dateType testDate;
  ...
  cout << endl << "From extDateType section (Part III):" << endl;
  extDateType testDate;
  cout << "Default constructor: ";
  testDate.printDate();
  testDate.printLongMonth();
  testDate.printLongMonthYear();
  testDate.printLongDate();
  cout << endl;

  
  extDateType date1(2, 20, 2003);
  cout << "Parameter constructor: ";
  date1.printDate();
  date1.printLongMonth();
